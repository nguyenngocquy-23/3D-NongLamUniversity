...
import styles from "../../styles/previewIcon3D.module.css";
...
const Icon3DPreviewWithSnapshot = ({ modelUrl, onThumbnailSaved }: Props) => {
    ...
    <div>
      <div className={styles.model_preview_container}>
        ...
        >
          ...
          <OrbitControls />
          <SnapshotHelper onSnapshotReady={setSnapshot} error={error} />
        </Canvas>
        {snapshot && (
          <div
          ...
          >
            <h5 className={styles.title}>Thumbnail</h5>
            <img
              src={snapshot}
              alt="snapshot"
...
export default Icon3DPreviewWithSnapshot;
